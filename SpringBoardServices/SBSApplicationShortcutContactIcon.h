...
@property(readonly, retain, nonatomic) NSString *lastName; // @synthesize lastName=_lastName;
@property(readonly, retain, nonatomic) NSString *firstName; // @synthesize firstName=_firstName;
@property(readonly, retain, nonatomic) NSString *contactIdentifier; // @synthesize contactIdentifier=_contactIdentifier;
