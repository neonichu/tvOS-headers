...
@interface CKDClientContext : NSObject <CKLoggingProtocol>
{
    ...
    _Bool _hasAllowAccessDuringBuddyEntitlement;
    _Bool _sandboxed;
...
@property(nonatomic) _Bool hasAllowAccessDuringBuddyEntitlement; // @synthesize hasAllowAccessDuringBuddyEntitlement=_hasAllowAccessDuringBuddyEntitlement;
