...
- (id)effectiveImageRepGivenCandidates:(CDUnknownBlockType)arg1;
- (id)effectiveFrameGivenImageRepCandidates:(CDUnknownBlockType)arg1;
- (id)effectiveFrameSizeGivenImageRepCandidates:(CDUnknownBlockType)arg1;
- (id)parent;
