...
@class AXAccessQueueTimer, AXUIAlert, NSString, UIImage;
...
@interface AXUIAlertContext : NSObject
{
    ...
    AXAccessQueueTimer *_showOrHideTimer;
...
@property(retain, nonatomic) AXAccessQueueTimer *showOrHideTimer; // @synthesize showOrHideTimer=_showOrHideTimer;
