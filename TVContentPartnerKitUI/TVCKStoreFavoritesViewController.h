...
#import <TVContentPartnerKitUI/TVCKStoreFavoritesViewDataSource-Protocol.h>
...
@interface TVCKStoreFavoritesViewController : UIViewController <TVCKStoreFavoritesViewDataSource, TVCKStoreFavoritesViewDelegate, TVSStoreFavoritesControllerDelegate>
{
...
- (void)storeFavoritesView:(id)arg1 didSelectItemAtIndex:(unsigned long long)arg2;
- (id)storeFavoritesView:(id)arg1 badgeCountForItemAtIndex:(unsigned long long)arg2;
- (id)storeFavoritesView:(id)arg1 imageURLForItemAtIndex:(unsigned long long)arg2;
- (id)storeFavoritesView:(id)arg1 titleForItemAtIndex:(unsigned long long)arg2;
- (unsigned long long)numberOfItemsForStoreFavoritesView:(id)arg1;
- (void)_askToRemoveUnavailableItem:(id)arg1;
- (void)_displayItems:(id)arg1;
- (void)_updateItems;
