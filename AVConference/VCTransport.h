...
- (int)sendData:(id)arg1 localIPPort:(struct tagIPPORT *)arg2 destinationIPPort:(struct tagIPPORT *)arg3 remoteCallID:(unsigned int)arg4 encrypted:(_Bool)arg5;
...
- (void)receivedDataPacket:(char *)arg1 length:(int)arg2 forCallID:(unsigned int)arg3 encrypted:(_Bool)arg4;
...
- (int)updateInterfaceList:(struct tagCONNRESULT *)arg1 shouldFilterCellInterface:(_Bool)arg2 isUpdateNeeded:(int *)arg3;
