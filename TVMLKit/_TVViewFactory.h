...
- (id)_spriteViewForElement:(id)arg1 existingView:(id)arg2;
...
- (id)_zoomableTextViewFromElement:(id)arg1 existingView:(id)arg2;
...
- (id)_playlistImgWithElement:(id)arg1 existingView:(id)arg2;
