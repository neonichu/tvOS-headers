...
@class NSArray, UIColor, UIImage, UILayoutGuide, _UIStackedImageContainerView;
...
@property(nonatomic, setter=_setCachedEdgeInsetsForEffects:) struct UIEdgeInsets _cachedEdgeInsetsForEffects;
...
@property(readonly, nonatomic) _Bool _templateSettingsAreInvalid;
- (void)_updateMasking;
