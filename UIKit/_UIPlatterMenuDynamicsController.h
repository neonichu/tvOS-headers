...
@property(retain, nonatomic) _UIPlatterMenuSnapBehavior *menuSnapBehavior; // @synthesize menuSnapBehavior=_menuSnapBehavior;
...
- (void)beginTransitionWithAnimatorUsingBehaviors:(id)arg1 observedItems:(id)arg2 stateIfCompleted:(long long)arg3 underDirectManipulation:(_Bool)arg4;
