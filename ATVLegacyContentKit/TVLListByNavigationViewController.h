...
@class NSIndexPath, NSString, TVLListByNavigationElement, TVLListViewDataSource, TVLPreviewFactory, UIActivityIndicatorView;
...
{
    TVLListByNavigationElement *_listByNavigationElement;
...
@property(retain, nonatomic) TVLListByNavigationElement *listByNavigationElement; // @synthesize listByNavigationElement=_listByNavigationElement;
- (void).cxx_destruct;
