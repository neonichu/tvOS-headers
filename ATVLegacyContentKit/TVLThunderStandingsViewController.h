...
@class CAGradientLayer, NSArray, NSString, TVImageView, TVLPropertyListElement, UICollectionView, UILabel, UIView;
...
{
    TVLPropertyListElement *_propertyListElement;
...
@property(retain, nonatomic) TVLPropertyListElement *propertyListElement; // @synthesize propertyListElement=_propertyListElement;
- (void).cxx_destruct;
