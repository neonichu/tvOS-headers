...
#import <HealthDaemon/HDDaemonDeviceManager-Protocol.h>
...
- (void).cxx_destruct;
- (id)shortDescription;
- (unsigned long long)connectHealthDevice:(id)arg1 healthDatabase:(id)arg2 sessionHandler:(CDUnknownBlockType)arg3 error:(id *)arg4;
...
- (unsigned long long)connectHealthDevice:(id)arg1 healthDatabase:(id)arg2 sessionHandler:(CDUnknownBlockType)arg3 transitoryHandler:(CDUnknownBlockType)arg4 characteristicsHandler:(CDUnknownBlockType)arg5 error:(id *)arg6;
