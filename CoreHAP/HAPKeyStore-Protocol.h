...
- (NSUUID *)readPeripheralIdentifierForAccessoryName:(NSString *)arg1 protocolVersion:(unsigned long long *)arg2 error:(id *)arg3;
- (_Bool)deleteAllPeripheralIdentifiers:(id *)arg1;
- (_Bool)deletePeripheralIdentifierForAccessoryName:(NSString *)arg1 error:(id *)arg2;
- (_Bool)updatePeripheralIdentifier:(NSUUID *)arg1 forAccessoryName:(NSString *)arg2 protocolVersion:(unsigned long long)arg3 error:(id *)arg4;
