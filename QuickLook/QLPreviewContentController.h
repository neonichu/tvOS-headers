...
@class NSMutableArray, NSMutableDictionary, NSMutableOrderedSet, NSMutableSet, NSString, QLAirPlayController, UIColor, UIGestureRecognizer, UILongPressGestureRecognizer, UIPageViewController, UIPanGestureRecognizer, UISegmentedControl, UITapGestureRecognizer, UIView;
