...
+ (void)_initializeAssetLibraryWithCachePath:(id)arg1 screensaverCache:(_Bool)arg2;
...
- (void)setImageAssetFromPath:(id)arg1 forKey:(id)arg2 inGroupOfType:(long long)arg3 extension:(id)arg4 expiryDate:(id)arg5;
- (void)setImageAssetFromPath:(id)arg1 forKey:(id)arg2 inGroupOfType:(long long)arg3 expiryDate:(id)arg4;
- (void)setImageAsset:(id)arg1 forKey:(id)arg2 inGroupOfType:(long long)arg3 extension:(id)arg4 expiryDate:(id)arg5;
...
- (id)initWithCachePath:(id)arg1 screensaverCache:(_Bool)arg2;
