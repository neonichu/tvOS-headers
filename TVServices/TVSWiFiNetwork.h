...
@property(readonly, nonatomic, getter=isManagedByProfile) _Bool managedByProfile; // @synthesize managedByProfile=_managedByProfile;
@property(readonly, nonatomic) float signalStrength; // @synthesize signalStrength=_signalStrength;
- (void)removeObserver:(id)arg1 forKeyPath:(id)arg2;
- (void)addObserver:(id)arg1 forKeyPath:(id)arg2 options:(unsigned long long)arg3 context:(void *)arg4;
- (_Bool)managedByProfile;
