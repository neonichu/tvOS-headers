...
@class NSError, NSString, NSUUID, NSXPCConnection, TVSSPlaybackActionOperationRequest, TVSSPlaybackActionOperationResult;
...
@interface TVSSPlaybackActionOperation : NSOperation
{
    ...
    TVSSPlaybackActionOperationResult *_result;
    NSError *_error;
...
@property(copy) TVSSPlaybackActionOperationResult *result; // @synthesize result=_result;
